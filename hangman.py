...
while play == True:
    ...
    if guess == '1':
       guessWord = input("Guess the word: ")                            #if user enters '1' they are able to guess the whole word, if they get it wrong they lose the whole game
